class Bun < Formula
  ...
  # Livecheck sits after the platform `url` blocks: with no root `url` stanza,
  # the LivecheckUrlSymbol cop derives "stable url" from the first `url` call
  # and would otherwise compare this URL against itself.
  livecheck do
